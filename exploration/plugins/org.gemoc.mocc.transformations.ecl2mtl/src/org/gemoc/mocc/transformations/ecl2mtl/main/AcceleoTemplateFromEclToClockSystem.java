 ...
 *******************************************************************************/
package org.gemoc.mocc.transformations.ecl2mtl.main;
 ...
 * @generated
 */
public class AcceleoTemplateFromEclToClockSystem extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "ecl2clocksystem" };
     ...
     * @generated
     */
    public AcceleoTemplateFromEclToClockSystem() {
     ...
     * @generated
     */
    public AcceleoTemplateFromEclToClockSystem(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public AcceleoTemplateFromEclToClockSystem(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                AcceleoTemplateFromEclToClockSystem generator = new AcceleoTemplateFromEclToClockSystem(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.xtend.core.xtend.XtendPackage.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.xtend.core.xtend.XtendPackage.eINSTANCE.getNsURI(), org.eclipse.xtend.core.xtend.XtendPackage.eINSTANCE);
        }
        
        if (!isInWorkspace(org.eclipse.xtend.core.richstring.ProcessedRichStringPackage.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.xtend.core.richstring.ProcessedRichStringPackage.eINSTANCE.getNsURI(), org.eclipse.xtend.core.richstring.ProcessedRichStringPackage.eINSTANCE);
        }
