...
public class Concurrent_mseAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Concurrent_mseSwitch<Adapter> modelSwitch =
		new Concurrent_mseSwitch<Adapter>() {
			@Override
			public Adapter caseFeedbackMSE(FeedbackMSE object) {
				return createFeedbackMSEAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gemoc.executionframework.engine.mse.MSE <em>MSE</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.eclipse.gemoc.executionframework.engine.mse.MSE
	 * @generated
	 */
