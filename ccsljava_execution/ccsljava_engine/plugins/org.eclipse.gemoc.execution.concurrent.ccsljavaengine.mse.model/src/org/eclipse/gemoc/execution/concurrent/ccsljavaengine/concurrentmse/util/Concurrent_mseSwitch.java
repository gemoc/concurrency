...
public class Concurrent_mseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Concurrent_msePackage.FEEDBACK_MSE: {
				FeedbackMSE feedbackMSE = (FeedbackMSE)theEObject;
				T result = caseFeedbackMSE(feedbackMSE);
				if (result == null) result = caseMSE(feedbackMSE);
				if (result == null) result = caseENamedElement(feedbackMSE);
				if (result == null) result = caseEModelElement(feedbackMSE);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feedback MSE</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Feedback MSE</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFeedbackMSE(FeedbackMSE object) {
		return null;
	}
