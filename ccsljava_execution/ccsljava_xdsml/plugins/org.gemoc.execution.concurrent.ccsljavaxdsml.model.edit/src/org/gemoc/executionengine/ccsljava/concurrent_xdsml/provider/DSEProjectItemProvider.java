...
/**
 * This is the item provider adapter for a {@link org.gemoc.executionengine.ccsljava.concurrent_xdsml.DSEProject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DSEProjectItemProvider extends ProjectResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Concurrent_xdsmlPackage.Literals.DSE_PROJECT__QVTO_URI,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Concurrent_xdsmlPackage.Literals.DSE_PROJECT__SOLVER_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
