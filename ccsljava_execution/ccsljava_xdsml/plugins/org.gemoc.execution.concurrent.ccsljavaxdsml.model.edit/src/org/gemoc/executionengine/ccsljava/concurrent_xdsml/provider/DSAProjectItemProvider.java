...
/**
 * This is the item provider adapter for a {@link org.gemoc.executionengine.ccsljava.concurrent_xdsml.DSAProject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DSAProjectItemProvider extends ProjectResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Concurrent_xdsmlPackage.Literals.DSA_PROJECT__CODE_EXECUTOR_CLASS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Concurrent_xdsmlPackage.Literals.DSA_PROJECT__ENTRY_POINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
