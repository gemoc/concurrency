...
public class FeedbackSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FeedbackPackage.WHEN: {
				When when = (When)theEObject;
				T result = caseWhen(when);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.FORCE: {
				Force force = (Force)theEObject;
				T result = caseForce(force);
				if (result == null) result = caseAction(force);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.ACTION_FINISHED_CONDITION: {
				ActionFinishedCondition actionFinishedCondition = (ActionFinishedCondition)theEObject;
				T result = caseActionFinishedCondition(actionFinishedCondition);
				if (result == null) result = caseCondition(actionFinishedCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.IMPORT_STATEMENT: {
				ImportStatement importStatement = (ImportStatement)theEObject;
				T result = caseImportStatement(importStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.MODEL_SPECIFIC_EVENT: {
				ModelSpecificEvent modelSpecificEvent = (ModelSpecificEvent)theEObject;
				T result = caseModelSpecificEvent(modelSpecificEvent);
				if (result == null) result = caseENamedElement(modelSpecificEvent);
				if (result == null) result = caseEModelElement(modelSpecificEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.ACTION_RESULT_CONDITION: {
				ActionResultCondition actionResultCondition = (ActionResultCondition)theEObject;
				T result = caseActionResultCondition(actionResultCondition);
				if (result == null) result = caseCondition(actionResultCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeedbackPackage.ACTION_MODEL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Action Finished Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Action Finished Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActionFinishedCondition(ActionFinishedCondition object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Action Result Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Action Result Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActionResultCondition(ActionResultCondition object) {
		return null;
	}
