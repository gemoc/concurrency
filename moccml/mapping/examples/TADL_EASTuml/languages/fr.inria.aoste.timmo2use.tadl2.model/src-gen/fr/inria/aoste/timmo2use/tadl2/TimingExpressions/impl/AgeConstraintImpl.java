 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.timmo2use.tadl2.TimingExpressions.impl.AgeConstraintImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link fr.inria.aoste.timmo2use.tadl2.TimingExpressions.impl.AgeConstraintImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link fr.inria.aoste.timmo2use.tadl2.TimingExpressions.impl.AgeConstraintImpl#getScope <em>Scope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AgeConstraintImpl extends TimingConstraintImpl implements AgeConstraint {
	...
	protected EClass eStaticClass() {
		return TimingExpressionsPackage.Literals.AGE_CONSTRAINT;
	}
	...
	public NotificationChain basicSetMinimum(TimingExpression newMinimum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TimingExpressionsPackage.AGE_CONSTRAINT__MINIMUM, oldMinimum, newMinimum);
	...
	public void setMinimum(TimingExpression newMinimum) {
		if (newMinimum != minimum) {
			...
			if (minimum != null)
				msgs = ((InternalEObject)minimum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TimingExpressionsPackage.AGE_CONSTRAINT__MINIMUM, null, msgs);
			if (newMinimum != null)
				msgs = ((InternalEObject)newMinimum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TimingExpressionsPackage.AGE_CONSTRAINT__MINIMUM, null, msgs);
			msgs = basicSetMinimum(newMinimum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimingExpressionsPackage.AGE_CONSTRAINT__MINIMUM, newMinimum, newMinimum));
	}
	...
	public NotificationChain basicSetMaximum(TimingExpression newMaximum, NotificationChain msgs) {
		...
		maximum = newMaximum;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM, oldMaximum, newMaximum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaximum(TimingExpression newMaximum) {
		if (newMaximum != maximum) {
			NotificationChain msgs = null;
			if (maximum != null)
				msgs = ((InternalEObject)maximum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM, null, msgs);
			if (newMaximum != null)
				msgs = ((InternalEObject)newMaximum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM, null, msgs);
			msgs = basicSetMaximum(newMaximum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM, newMaximum, newMaximum));
	}
	...
	public EventChain getScope() {
		if (scope != null && scope.eIsProxy()) {
			...
			if (scope != oldScope) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TimingExpressionsPackage.AGE_CONSTRAINT__SCOPE, oldScope, scope));
			}
		}
		return scope;
	}
	...
	public void setScope(EventChain newScope) {
		...
		scope = newScope;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimingExpressionsPackage.AGE_CONSTRAINT__SCOPE, oldScope, scope));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TimingExpressionsPackage.AGE_CONSTRAINT__MINIMUM:
				return basicSetMinimum(null, msgs);
			case TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TimingExpressionsPackage.AGE_CONSTRAINT__MAXIMUM:
				return getMaximum();
			case TimingExpressionsPackage.AGE_CONSTRAINT__SCOPE:
