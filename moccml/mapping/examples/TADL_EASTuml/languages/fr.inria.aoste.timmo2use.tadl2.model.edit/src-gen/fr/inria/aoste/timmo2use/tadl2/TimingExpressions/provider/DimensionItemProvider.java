...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.timmo2use.tadl2.TimingExpressions.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_kind_feature", "_UI_Dimension_type"),
				 TimingExpressionsPackage.Literals.DIMENSION__KIND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimingExpressionsPackage.Literals.DIMENSION__UNITS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dimension.class)) {
			case TimingExpressionsPackage.DIMENSION__KIND:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case TimingExpressionsPackage.DIMENSION__UNITS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TimingExpressionsPackage.Literals.DIMENSION__UNITS,
				 TimingExpressionsFactory.eINSTANCE.createUnit()));
	}
