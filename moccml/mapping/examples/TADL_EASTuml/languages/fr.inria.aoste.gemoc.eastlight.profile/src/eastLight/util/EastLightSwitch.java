 ...
 * @generated
 */
public class EastLightSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EastLightPackage.ANALYSIS_FUNCTION_TYPE: {
			...
			case EastLightPackage.FLOW_PORT: {
