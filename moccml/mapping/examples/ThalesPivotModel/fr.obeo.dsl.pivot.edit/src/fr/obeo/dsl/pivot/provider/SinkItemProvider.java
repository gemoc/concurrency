...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.pivot.Sink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SinkItemProvider
	extends StimuliItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sink_fragment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sink_fragment_feature", "_UI_Sink_type"),
				 PivotPackage.Literals.SINK__FRAGMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sink_chain_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sink_chain_feature", "_UI_Sink_type"),
				 PivotPackage.Literals.SINK__CHAIN,
				 true,
				 false,
				 true,
				 null,
