...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.pivot.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSchedulingIndexPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PivotPackage.Literals.TASK__PRIORITY,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Scheduling Index feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSchedulingIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_schedulingIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_schedulingIndex_feature", "_UI_Task_type"),
				 PivotPackage.Literals.TASK__SCHEDULING_INDEX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addFragmentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_fragments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_fragments_feature", "_UI_Task_type"),
				 PivotPackage.Literals.TASK__FRAGMENTS,
				 true,
				 false,
				 true,
				 null,
