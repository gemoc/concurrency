 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.gemoc.example.tfsm.TemporalGuard#getOnClock <em>On Clock</em>}</li>
 *   <li>{@link fr.inria.aoste.gemoc.example.tfsm.TemporalGuard#getAfterDuration <em>After Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.aoste.gemoc.example.tfsm.TfsmPackage#getTemporalGuard()
 * @model
 * @generated
 */
public interface TemporalGuard extends Guard {
	 ...
	 * @see fr.inria.aoste.gemoc.example.tfsm.TfsmPackage#getTemporalGuard_OnClock()
	 * @model required="true"
	 * @generated
	 */
	FSMClock getOnClock();
	...
	/**
	 * Sets the value of the '{@link fr.inria.aoste.gemoc.example.tfsm.TemporalGuard#getOnClock <em>On Clock</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.inria.aoste.gemoc.example.tfsm.TfsmPackage#getTemporalGuard_AfterDuration()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fr.inria.aoste.gemoc.example.tfsm.TemporalGuard#getAfterDuration <em>After Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
