 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.gemoc.example.tfsm.impl.StateImpl#getOwningFSM <em>Owning FSM</em>}</li>
 *   <li>{@link fr.inria.aoste.gemoc.example.tfsm.impl.StateImpl#getOutgoingTransition <em>Outgoing Transition</em>}</li>
 *   <li>{@link fr.inria.aoste.gemoc.example.tfsm.impl.StateImpl#getIncomingTransition <em>Incoming Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends NamedElementImpl implements State {
	...
	public void setOwningFSM(TFSM newOwningFSM) {
		if (newOwningFSM != eInternalContainer() || (eContainerFeatureID() != TfsmPackage.STATE__OWNING_FSM && newOwningFSM != null)) {
			...
			if (newOwningFSM != null)
				msgs = ((InternalEObject)newOwningFSM).eInverseAdd(this, TfsmPackage.TFSM__OWNED_STATE, TFSM.class, msgs);
	...
	public EList<Transition> getOutgoingTransition() {
		if (outgoingTransition == null) {
			outgoingTransition = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, TfsmPackage.STATE__OUTGOING_TRANSITION, TfsmPackage.TRANSITION__SOURCE);
		}
	...
	public EList<Transition> getIncomingTransition() {
		if (incomingTransition == null) {
			incomingTransition = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, TfsmPackage.STATE__INCOMING_TRANSITION, TfsmPackage.TRANSITION__TARGET);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case TfsmPackage.STATE__INCOMING_TRANSITION:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TfsmPackage.STATE__OWNING_FSM:
				return eInternalContainer().eInverseRemove(this, TfsmPackage.TFSM__OWNED_STATE, TFSM.class, msgs);
		}
