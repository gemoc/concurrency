...
public class TfsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TfsmPackage.SYSTEM: {
				fr.inria.aoste.gemoc.example.tfsm.System system = (fr.inria.aoste.gemoc.example.tfsm.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(fr.inria.aoste.gemoc.example.tfsm.System object) {
		return null;
	}
