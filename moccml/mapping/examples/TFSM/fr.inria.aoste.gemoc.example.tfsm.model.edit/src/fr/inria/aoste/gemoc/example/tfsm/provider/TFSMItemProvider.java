...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.gemoc.example.tfsm.TFSM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TFSMItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.TFSM__OWNED_STATE);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TFSM__OWNED_STATE,
				 TfsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TFSM__OWNED_EVENTS,
