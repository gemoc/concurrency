...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.gemoc.example.tfsm.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.STATE__INCOMING_TRANSITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.STATE__OUTGOING_TRANSITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(State.class)) {
			case TfsmPackage.STATE__OUTGOING_TRANSITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.STATE__OUTGOING_TRANSITION,
