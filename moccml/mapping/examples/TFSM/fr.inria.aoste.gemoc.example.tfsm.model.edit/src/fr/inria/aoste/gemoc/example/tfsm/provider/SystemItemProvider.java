/**
 */
package fr.inria.aoste.gemoc.example.tfsm.provider;
...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.gemoc.example.tfsm.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.SYSTEM__TFSMS);
			childrenFeatures.add(TfsmPackage.Literals.SYSTEM__GLOBAL_CLOCKS);
			childrenFeatures.add(TfsmPackage.Literals.SYSTEM__GLOBAL_EVENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(fr.inria.aoste.gemoc.example.tfsm.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.SYSTEM__TFSMS,
				 TfsmFactory.eINSTANCE.createTFSM()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.SYSTEM__GLOBAL_CLOCKS,
				 TfsmFactory.eINSTANCE.createFSMClock()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.SYSTEM__GLOBAL_EVENT,
