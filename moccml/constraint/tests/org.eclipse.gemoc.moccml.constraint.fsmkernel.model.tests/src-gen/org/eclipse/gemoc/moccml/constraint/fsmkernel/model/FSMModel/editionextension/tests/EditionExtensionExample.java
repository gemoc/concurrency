...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>editionextension</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EditionExtensionExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(EditionExtensionPackage.eNS_URI, 
			 EditionExtensionPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.editionextension"));
				IntegerAssignementBlock root = EditionExtensionFactory.eINSTANCE.createIntegerAssignementBlock();
