...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>FSMModel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FSMModelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FSMModelPackage.eNS_URI, 
			 FSMModelPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.fsmmodel"));
				State root = FSMModelFactory.eINSTANCE.createState();
