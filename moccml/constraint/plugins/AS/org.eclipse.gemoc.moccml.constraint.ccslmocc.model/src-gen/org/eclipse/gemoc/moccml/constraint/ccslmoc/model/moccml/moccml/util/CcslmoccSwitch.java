...
public class CcslmoccSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CcslmoccPackage.STATE_RELATION_BASED_LIBRARY: {
				StateRelationBasedLibrary stateRelationBasedLibrary = (StateRelationBasedLibrary)theEObject;
				T result = caseStateRelationBasedLibrary(stateRelationBasedLibrary);
				if (result == null) result = caseLibrary(stateRelationBasedLibrary);
				if (result == null) result = caseNamedElement(stateRelationBasedLibrary);
			...
			case CcslmoccPackage.FINISH_CLOCK: {
				...
				if (result == null) result = caseAbstractAction(finishClock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Relation Based Library</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Relation Based Library</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateRelationBasedLibrary(StateRelationBasedLibrary object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Machine Relation Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Machine Relation Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateMachineRelationDefinition(StateMachineRelationDefinition object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Start Clock</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Start Clock</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStartClock(StartClock object) {
		return null;
	}
