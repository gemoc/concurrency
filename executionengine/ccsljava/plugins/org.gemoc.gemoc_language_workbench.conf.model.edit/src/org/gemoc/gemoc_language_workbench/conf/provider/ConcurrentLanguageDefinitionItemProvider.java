...
/**
 * This is the item provider adapter for a {@link org.gemoc.gemoc_language_workbench.conf.ConcurrentLanguageDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcurrentLanguageDefinitionItemProvider extends LanguageDefinitionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__DSA_PROJECT);
			childrenFeatures.add(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__MO_CC_PROJECT);
			childrenFeatures.add(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__DSE_PROJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__DSA_PROJECT,
				 confFactory.eINSTANCE.createDSAProject()));

		newChildDescriptors.add
			(createChildParameter
				(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__MO_CC_PROJECT,
				 confFactory.eINSTANCE.createMoCCProject()));

		newChildDescriptors.add
			(createChildParameter
				(confPackage.Literals.CONCURRENT_LANGUAGE_DEFINITION__DSE_PROJECT,
