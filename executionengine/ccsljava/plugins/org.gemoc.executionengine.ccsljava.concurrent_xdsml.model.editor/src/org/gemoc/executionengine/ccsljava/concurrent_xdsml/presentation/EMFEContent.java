  ...
  class EMFEContent extends org.eclipse.emf.ecore.util.EContentAdapter{
	...
	EMFEContent(XDSMLModelWrapper xdsmlModelWrapper) {
		...
		private void handleLanguageDefinitionNotification(Notification n) {
			int featureID = n.getFeatureID(org.gemoc.executionengine.ccsljava.concurrent_xdsml.ConcurrentLanguageDefinition.class);
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.CONCURRENT_LANGUAGE_DEFINITION__NAME){
		...
		private void handleMoCProjectNotification(Notification n) {
			int featureID = n.getFeatureID(org.gemoc.executionengine.ccsljava.concurrent_xdsml.MoCCProject.class);
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.MO_CC_PROJECT__PROJECT_NAME){
	        		String oldValue = n.getOldStringValue();
	        		String newValue = n.getNewStringValue();
		...
		private void handleDSAProjectNotification(Notification n) {
			int featureID = n.getFeatureID(org.gemoc.executionengine.ccsljava.concurrent_xdsml.DSAProject.class);
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.DSA_PROJECT__PROJECT_NAME){
	        		String oldValue = n.getOldStringValue();
	        		String newValue = n.getNewStringValue();
	                this.xdsmlModelWrapper.firePropertyChange("DSAProjectName", oldValue, newValue);
	        }
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.DSA_PROJECT__CODE_EXECUTOR_CLASS){
        		String oldValue = n.getOldStringValue();
        		String newValue = n.getNewStringValue();
		...
		private void handleDSEProjectNotification(Notification n) {
			int featureID = n.getFeatureID(org.gemoc.executionengine.ccsljava.concurrent_xdsml.DSEProject.class);
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.DSE_PROJECT__PROJECT_NAME){
	        		String oldValue = n.getOldStringValue();
	        		String newValue = n.getNewStringValue();
	                this.xdsmlModelWrapper.firePropertyChange("DSEProjectName", oldValue, newValue);
	        }
	        if (featureID == org.gemoc.executionengine.ccsljava.concurrent_xdsml.Concurrent_xdsmlPackage.DSE_PROJECT__QVTO_URI){
        		String oldValue = n.getOldStringValue();
        		String newValue = n.getNewStringValue();
