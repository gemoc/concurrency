...
/**
 * This is the action bar contributor for the Concurrent_xdsml model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Concurrent_xdsmlActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public Concurrent_xdsmlActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("concurrent_xdsml-settings"));
		toolBarManager.add(new Separator("concurrent_xdsml-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_Concurrent_xdsmlEditor_menu"), "org.gemoc.executionengine.ccsljava.concurrent_xdsmlMenuID");
		...
		//
		createChildMenuManager = new MenuManager(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(Concurrent_xdsmlEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
