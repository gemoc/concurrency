...
/**
 * This is the item provider adapter for a {@link org.gemoc.gel.microgel.FeedbackFilter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeedbackFilterItemProvider 
	 ...
	 * @generated
	 */
	public FeedbackFilterItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicrogelPackage.Literals.FEEDBACK_FILTER__BODY);
		}
	...
	/**
	 * This returns FeedbackFilter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeedbackFilter"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_FeedbackFilter_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeedbackFilter.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicrogelPackage.Literals.FEEDBACK_FILTER__BODY,
	...
	public ResourceLocator getResourceLocator() {
		return MicrogelEditPlugin.INSTANCE;
	}
